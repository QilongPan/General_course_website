...
<div style=" width:35%; height:100%; float:left">
    <div style=" width:80%; margin:0 auto">
       <ul id="nav">
           <li style="background-color:#F00; color:#FFF">教学团队</li>
           <li><a href="frontJsp/eight.jsp">团队成员</a></li>
            <li></li>
       </ul>
    </div>
</div>
...
<div style=" width:60%; height:700px; float:right">
    <div style="clear:both; height:20px; margin-top:30px">
            <h3 style=" color:#F00; float:left; margin-top:0px"><img src="img/tv.png" width="17" height="20" />教学团队</h3>
          <p style="float:right; margin-top:0px; color:#990000">教学团队</p>

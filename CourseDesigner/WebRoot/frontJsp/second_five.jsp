...
<html>
  <head>
    ...
    <title>My JSP 'second_five.jsp' starting page</title>
...
<div style=" width:60%; height:700px; float:right">
    <div style="clear:both; height:20px; margin-top:30px">
            <h3 style=" color:#F00; float:left; margin-top:0px"><img src="img/tv.png" width="17" height="20" />课程理念与目标</h3>
          <p style="float:right; margin-top:0px; color:#990000">课程理念与目标</p>
      ...
      <div style=" float:left;height:640px;width:100%">
    		<s:property value="%{#request.course.courseMu}"/>
      </div>  
</div>
</div>
</body>

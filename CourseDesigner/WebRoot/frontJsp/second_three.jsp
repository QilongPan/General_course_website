...
<html>
  <head>
    ...
    <title>My JSP 'second_three.jsp' starting page</title>
...
<div style=" width:60%; height:700px; float:right">
    <div style="clear:both; height:20px; margin-top:30px">
            <h3 style=" color:#F00; float:left; margin-top:0px"><img src="img/tv.png" width="17" height="20" />课程安排</h3>
          <p style="float:right; margin-top:0px; color:#990000">课程安排</p>
      ...
      <div style=" float:left;height:640px;width:100%">
     		<s:property value="%{#request.course.courseArange}"/>
      </div>  
</div>
</div>
</body>

...
<a href="main.html"  target="menuFrame"><i class="glyph-icon icon-home"></i>网站内容管理</a>
            ...
            <li class="childUlLi">
                <a > <i class="glyph-icon  icon-location-arrow"></i>系统设置</a>
                <ul>
                    <li><a target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>权限管理</a></li>
                    <li><a  target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>模块管理</a></li>
    ...
    <div id="layout_right_content" class="layout_right_content">
        ...
        <div class="route_bg">
            <a>文章管理</a><i class="glyph-icon icon-chevron-right"></i>
        </div>

...
<a href="main.html"  target="menuFrame"><i class="glyph-icon icon-home"></i>网站内容管理</a>
                <ul>
                    <li><a href="user_add.html" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>留言管理</a></li>
                    <li><a href="user_add.html" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>文章管理</a></li>
                    <li><a href="user_add.html" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>审核文章</a></li>
                    <li><a href="user_add.html" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>栏目管理</a></li>
            ...
            <li class="childUlLi">
                ...
                <ul>
                    ...
                    <li><a href="#" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>角色分配</a></li>
                    <li><a href="#" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>人员管理</a></li>
                    <li><a href="#" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>角色管理</a></li>
                    <li><a href="#" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>默认功能设置</a></li>
                    <li><a href="#" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>首页信息设置</a></li>
                    <li><a href="#" target="menuFrame"><i class="glyph-icon icon-chevron-right"></i>码表管理</a></li>
                </ul>
            </li>
        </ul>
    </div>
    ...
    <div id="layout_right_content" class="layout_right_content">
        ...
        <div class="mian_content">
            <div id="page_content">
                <iframe id="menuFrame" name="menuFrame" src="jsp/print.jsp" style="overflow:visible;"
